...
create table recipe (id bigint not null auto_increment, description varchar(255), cook_time integer, difficulty varchar(255), directions longtext, image longblob, prep_time integer, servings integer, source varchar(255), url varchar(255), notes_id bigint, primary key (id)) engine=InnoDB;
